...
const ViewItemDetailsModal = ({ itemInfo, handleItemViewModalClose }) => {
  ...
  const updateInfoCall = async (values) => {
    if (isFormDisabled) {
      return;
    }
    try {
      const updateCall = () =>
        fetch(`/api/admin/update-item-info/${itemInfo.id}`, {
          method: "PUT",
          headers: {
      ...
      await toast.promise(updateCall(), {
        ...
        success: (res) => {
          ...
          handleItemViewModalClose();
          return <b>Updated successfully!</b>;
        },
        error: (err) => <b>{err.toString()}</b>,
      });
    } catch (error) {
      console.log("Update product info error", error);
    }
  };
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-black/40 z-50">
      <div className="relative p-4 w-full max-w-4xl max-h-full ">
        <div className="relative bg-white rounded-lg shadow ">
          <button
            onClick={() => handleItemViewModalClose()}
            type="button"
          ...
          <button
            ...
            className="absolute top-16 left-16 shadow-md p-3 rounded-full"
          >
            <EditPen />
          </button>
          ...
          <div className="p-4 md:p-5 text-center">
            ...
            <ViewDetailsDialogTitleText>
              The provided information is provided by the author of the system
            </ViewDetailsDialogTitleText>
            ...
            <button
              ...
              disabled={isFormDisabled}
              className="bg-red-600 text-white m-auto p-3 rounded-md"
            >
              Update
            </button>
          </div>
